@props(['title' => 'Lexford Law', 'description' => ''])
{{--
THESIS: an established firm that speaks plainly — calm, warm, assured.
OWN-WORLD: ivory canvas, green-black ink, hairline lines, Newsreader headings over
Inter text, warm editorial photography with soft corners, pill buttons, and one
forest-green accent kept for the main button and the two green panels.
SIGNATURE: the wordmark (sections/wordmark) — the firm's short name set enormous,
rising out of the bottom of the team photograph. Keep it on the homepage.
--}}
<!doctype html>
<html lang="en">
<head>
...
<link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Inter:opsz,wght@14..32,400..600&family=Newsreader:ital,opsz,wght@0,6..72,300..500;1,6..72,300..500&display=swap">
