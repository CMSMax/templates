@props(['title' => 'Gleam Home Cleaning', 'description' => ''])
<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8">
...
<link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Archivo:wdth,wght@100..125,500..700&family=Geist:wght@400..600&display=swap">
@vite(['resources/css/site.css'])
</head>
<body class="bg-canvas font-sans text-ink antialiased" data-instant-navigation>
    {{--
    THESIS: an honest cleaning company, presented like good refill-soap packaging — bright, calm, exact.
    OWN-WORLD: white canvas, rinse-blue label panels, navy ink, heavy and hairline rules, Archivo
    semi-expanded over Geist, and one glove-yellow accent for the booking button, the seal and the ticks.
    SIGNATURE: the Clean Facts label (sections/clean-facts) — the checklist set like a nutrition panel.
    --}}
