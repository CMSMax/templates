<header class="sticky top-0 z-40 border-b border-line bg-canvas/85 backdrop-blur-md">
    <nav aria-label="Main" class="mx-auto grid h-16 max-w-6xl grid-cols-[1fr_auto_1fr] items-center gap-8 px-6">
        ...
        <div class="flex items-center gap-3 justify-self-end">
            ...
            <button type="button" data-nav-toggle aria-expanded="false" aria-controls="mobile-nav" class="rounded-lg border border-line px-3 py-2 text-sm font-medium text-ink hover:border-ink/30 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent md:hidden">Menu</button>
        </div>
    </nav>
