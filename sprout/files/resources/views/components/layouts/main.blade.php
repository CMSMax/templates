@props(['title' => 'Sprout Early Learning', 'description' => '', 'image' => ''])
<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8">
...
<link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Figtree:ital,wght@0,400..700;1,400&family=Fredoka:wght@400..600&display=swap">
@vite(['resources/css/site.css'])
</head>
<body class="bg-canvas font-sans text-ink antialiased" data-instant-navigation>
    {{--
    THESIS: a calm, sunlit early-learning house — refuses the rainbow, cartoon-clutter daycare site.
    OWN-WORLD: pale linen-sage canvas, deep leaf-green ink and bands, sunflower accent, soft rounded
    photographs, rounded Fredoka headings over Figtree text, three small rotated sticker words.
    STORY: a parent sees it is safe and warm, finds the right program for their child's age, and books a tour.
    FIRST VIEWPORT: floating pill nav; centered sticker headline with one sunflower CTA; wide rounded photo.
    SIGNATURE: the growth chart — programs by age stepping taller like a height chart on a door frame.
    --}}
