@props(['title' => 'Curbside Taco Co.', 'description' => '', 'image' => ''])
<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8">
...
<link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Big+Shoulders+Display:wght@600..900&family=Archivo:wght@400..700&display=swap">
@vite(['resources/css/site.css'])
</head>
<body class="bg-canvas font-sans text-ink antialiased" data-instant-navigation>
    {{--
    THESIS: the food truck's website is its parking schedule; refuses the burger-template hero → cards → reviews stack.
    OWN-WORLD: the curb — pale concrete, asphalt ink bands, one painted traffic-yellow, hazard stripes, ruled rows, uppercase street-sign type (Big Shoulders Display + Archivo).
    STORY: a hungry passer-by learns where the truck is next, what's worth ordering, and that it can come to their event.
    FIRST VIEWPORT: huge uppercase headline and the next-stop ticket beside a tall photo of the truck at a yellow curb; a rolling yellow curb band of menu names beneath.
    SIGNATURE: the stops board — this week's spots on asphalt, next stop lit yellow.
    --}}
